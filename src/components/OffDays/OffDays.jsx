...
const OffDays = () => {
  ...
  useEffect(() => {
    axios.get('http://103.209.41.225:31218/get-off-days')
      .then(response => {
  ...
  const handleResetOffDays = async () => {
    try {
      await axios.delete('http://103.209.41.225:31218/reset-off-days');
  ...
  const handleSubmit = () => {
    ...
    axios.post('http://103.209.41.225:31218/save-off-days', {
